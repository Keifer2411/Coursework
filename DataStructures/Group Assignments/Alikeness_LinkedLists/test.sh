...
./${program} "haru_miya=haru_miya${group}1.txt;jitu_miya=jitu_miya${group}1.txt;output=output${group}1.txt" 1>1.stdcout 2>1.stderr
...
./${program} "haru_miya=haru_miya${group}2.txt;jitu_miya=jitu_miya${group}2.txt;output=output${group}2.txt" 1>1.stdcout 2>1.stderr
# compare 1.out with 1.ans, output the difference to 1.diff
...
./${program} "haru_miya=haru_miya${group}3.txt;jitu_miya=jitu_miya${group}3.txt;output=output${group}3.txt" 1>1.stdcout 2>1.stderr
# compare 1.out with 1.ans, output the difference to 1.diff
